...
> System overview. Reasoning for every choice lives in [DECISIONS.md](DECISIONS.md). Master plan in [../../PLAN.md](../../PLAN.md).
...
### apps/ragent — RAG + agent service *(in active development — 9/14)*
