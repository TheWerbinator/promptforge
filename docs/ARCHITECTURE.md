...
### apps/ragent — RAG + agent service *(feature-complete — 14/14)*
...
| `DemoUsage` (`ragent_demo_usage`) | Per-IP + global daily free-turn caps for the demo agent (HMAC'd IP) | ✓ ragent phase 13 (migration `0011`) |
